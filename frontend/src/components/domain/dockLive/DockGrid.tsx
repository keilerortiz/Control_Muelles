...
type DockAppointment = Appointment & { Id: number };
type DetailMap = Record<number, AppointmentDetail | null | undefined>;

function resolveDesktopGridColumns(count: number) {
...
export function DockGrid({
  appointments = [],
  detailsByAppointmentId = {},
  nowMs,
}: {
  appointments?: DockAppointment[];
  detailsByAppointmentId?: DetailMap;
  nowMs: number;
}) {
